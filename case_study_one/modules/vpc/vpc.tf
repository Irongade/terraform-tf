...
resource "aws_vpc" "main_vpc" {
  cidr_block       = var.MAIN_VPC_CIDR_BLOC
...
resource "aws_subnet" "main_vpc_public_subnet_1" {
  ...
  cidr_block = var.MAIN_VPC_PUBLIC_SUBNET1_CIDR_BLOCK
  availability_zone = data.aws_availability_zones.available.names[0]
  map_public_ip_on_launch = "true"
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-public-subnet-1"
  }
}
#public Subnet 2
resource "aws_subnet" "main_vpc_public_subnet_2" {
  vpc_id     = aws_vpc.main_vpc.id
  cidr_block = var.MAIN_VPC_PUBLIC_SUBNET2_CIDR_BLOCK
  availability_zone = data.aws_availability_zones.available.names[1]
  map_public_ip_on_launch = "true"
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-public-subnet-2"
  }
}
...
resource "aws_subnet" "main_vpc_private_subnet_1" {
  vpc_id     = aws_vpc.main_vpc.id
  cidr_block = var.MAIN_VPC_PRIVATE_SUBNET1_CIDR_BLOCK
  availability_zone = data.aws_availability_zones.available.names[0]
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-private-subnet-1"
  }
}
# private subnet 2
resource "aws_subnet" "main_vpc_private_subnet_2" {
  vpc_id     = aws_vpc.main_vpc.id
  cidr_block = var.MAIN_VPC_PRIVATE_SUBNET2_CIDR_BLOCK
  availability_zone = data.aws_availability_zones.available.names[1]
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-private-subnet-2"
  }
}
...
resource "aws_internet_gateway" "main_igw" {
  ...
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-internet-gateway"
  }
}
...
resource "aws_nat_gateway" "main_ngw" {
  ...
  depends_on = [aws_internet_gateway.main_igw]
  tags = {
    Name = "${var.ENVIRONMENT}-main-vpc-NAT-gateway"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "${var.ENVIRONMENT}-main-public-route-table"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "${var.ENVIRONMENT}-main-private-route-table"
  }
}
...
output "private_subnet1_id" {
  ...
  value       = aws_subnet.main_vpc_private_subnet_1.id
}

output "private_subnet2_id" {
  description = "Subnet ID"
  value       = aws_subnet.main_vpc_private_subnet_2.id
}

output "public_subnet1_id" {
  description = "Subnet ID"
  value       = aws_subnet.main_vpc_public_subnet_1.id
}

output "public_subnet2_id" {
  description = "Subnet ID"
  value       = aws_subnet.main_vpc_public_subnet_2.id
}
